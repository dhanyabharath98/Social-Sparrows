...
Sys.time()-start.time
saveRDS(data1a,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/1a/data1a.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data1b,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/1b/data1b.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data1c,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/1c/data1c.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data2a,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/2a/data2a.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data2b,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/2b/data2b.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data2c,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/2c/data2c.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data3a,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/3a/data3a.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data3b,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/3b/data3b.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data3c,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/3c/data3c.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data4a,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/4a/data4a.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data4b,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/4b/data4b.Rdata"))
###
...
Sys.time()-start.time
saveRDS(data4c,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/4c/data4c.Rdata"))
###
#####
...
#####################################
data <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/4c/data4c.Rdata")
Totrec <- data[[1]]
#Totrec format:
...
plot(1:G,apply(Meanrec[1,,],1,mean),type="l",ylim=c(-3,3),ylab="Mean gene values",xlab="Generations",cex.lab=1) #Elevation
for(r in 1:10){
...
legend("topleft",legend=c("Elevation","Slope","Noise","Memory","Information"),col=c(1:4,7),pch=1,cex=0.7)
#lines(1:G,rep(a/f+(1/N),G),lty=2) # If you want to draw the line for the ESS you need to define the parameters a, f and N.
...
legend("topleft", legend=c("Producers","Scroungers"),col=c("Blue","Red"),pch=1,cex=0.7)
...
legend("topleft", legend = c("Mixed","Step-%s","Step-p","Log-%s","Log-p","Learning-%s","Learning-p","Pure"),
       col=c(1:8),pch=1,cex=0.7)
abline(h=0,col="gray",lty = "solid",lwd = 2)
...
for(z in sample(1:Rounds,min(10,Rounds))){
  plot(infos,infos,type="n",xlab="",ylab="")
  for (i in sample(1:N,50,replace=F)){
    ...
    #if(abs(Totrec[1,i,G,z])<5*Totrec[3,i,G,z]){
    #  lines(seq(0,1,0.01),ys,lty=1,col=2)#pure strategies
    #}
    #else if(abs(Totrec[1,i,G,z])>5*Totrec[3,i,G,z]){
    #  lines(seq(0,1,0.01),ys,lty=1,col=12)#mixed strategies
    #}
    #else{
    #  lines(seq(0,1,0.01),ys,lty=1,col=7)#plastic strategies
    #}
    if(abs(Totrec[2,i,G,z])>0.01){
      lines(seq(0,1,0.01),ys,lty=1,col="Light pink")#plastic strategies = pink
    }
    else{
      lines(seq(0,1,0.01),ys,lty=1,col="Dark green")#non-plastic strategies
    }
  }
}
...
colnames(noise_scale) <- c("None","Within","Between","Both")
...
saveRDS(noise_scale,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/noise_scale.Rdata"))
noise_scale <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/noise_scale.Rdata")
vioplot(noise_scale, col = alpha(2:5,alpha=0.2),ylim=c(0,3),xlab="Scale of environmental variation",ylab = "Noise",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
...
colnames(elev_scale) <- c("None","Within","Between","Both")
...
saveRDS(elev_scale,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/elev_scale.Rdata"))
elev_scale <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/elev_scale.Rdata")
vioplot(elev_scale, col = alpha(2:5,alpha=0.2),ylim=c(-3.5,0),xlab="Scale of environmental variation",ylab = "Elevation",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
points(jitter(c(rep(1,10),rep(2,10),rep(3,10),rep(4,10))),elev_scale,add=T, col = pal[1:10], pch=20, cex=1.5)
abline(h=0,col="gray",lty = "solid",lwd = 2)
##

##Slope##
slope_scale <- array(0, dim=c(10,4))
colnames(slope_scale) <- c("None","Within","Between","Both")
slope_scale[,1] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
slope_scale[,2] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
slope_scale[,3] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
slope_scale[,4] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
saveRDS(slope_scale,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/slope_scale.Rdata"))
slope_scale <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/slope_scale.Rdata")
vioplot(slope_scale, col = alpha(2:5,alpha=0.2),xlab="Scale of environmental variation",ylab = "Slope",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
points(jitter(c(rep(1,10),rep(2,10),rep(3,10),rep(4,10))),slope_scale,add=T, col = pal[1:10], pch=20, cex=1.5)
abline(h=0,col="gray",lty = "solid",lwd = 2)
##

##Pure strategies##
#pure_scale <- array(0, dim=c(10,4))
#colnames(pure_scale) <- c("Case 1","Case 2","Case 3","Case 4")
...
#saveRDS(pure_scale,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/pure_scale.Rdata"))
#pure_scale <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/pure_scale.Rdata")
...
#colnames(mixed_scale) <- c("Case 1","Case 2","Case 3","Case 4")
...
#saveRDS(mixed_scale,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/mixed_scale.Rdata"))
#mixed_scale <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Scale/mixed_scale.Rdata")
#vioplot(mixed_scale, col = alpha(2:5,alpha=0.2),xlab="Scale of environmental variation",ylab = "Proportion of mixed strategies",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
...
saveRDS(noise_ac,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/noise_ac.Rdata"))
noise_ac <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/noise_ac.Rdata")
vioplot(noise_ac, col = alpha(2:5,alpha=0.2),ylim=c(0,3),xlab="Environmental autocorrelation",ylab = "Noise",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
...
saveRDS(elev_ac,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/elev_ac.Rdata"))
elev_ac <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/elev_ac.Rdata")
vioplot(elev_ac, col = alpha(2:5,alpha=0.2),ylim=c(-3.5,0),xlab="Environmental autocorrelation",ylab = "Elevation",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
points(jitter(c(rep(1,10),rep(2,10),rep(3,10))),elev_ac,add=T, col = pal[1:10], pch=20, cex=1.5)
abline(h=0,col="gray",lty = "solid",lwd = 2)
##

##Slope##
slope_ac <- array(0, dim=c(10,3))
colnames(slope_ac) <- c("0","0.5","0.99")
slope_ac[,1] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
slope_ac[,2] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
slope_ac[,3] <- apply(Meanrec[3,(G-100):G,], FUN = mean, MARGIN = 2)
saveRDS(slope_ac,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/slope_ac.Rdata"))
slope_ac <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/slope_ac.Rdata")
vioplot(slope_ac, col = alpha(2:5,alpha=0.2),xlab="Environmental autocorrelation",ylab = "Slope",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
points(jitter(c(rep(1,10),rep(2,10),rep(3,10))),slope_ac,add=T, col = pal[1:10], pch=20, cex=1.5)
abline(h=0,col="gray",lty = "solid",lwd = 2)
##
...
#saveRDS(pure_ac,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/pure_ac.Rdata"))
#pure_ac <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/pure_ac.Rdata")
...
#saveRDS(mixed_ac,file=paste0("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/mixed_ac.Rdata"))
#mixed_ac <- readRDS("/Users/MyPC/Desktop/Social sparrows/Code/NEW/Plastic/Autocorrelation/mixed_ac.Rdata")
#vioplot(mixed_ac, col = alpha(2:5,alpha=0.2),xlab="Environmental autocorrelation",ylab = "Proportion of mixed strategies",colMed = "black",rectCol = "grey",cex.lab=2,border=NA)
